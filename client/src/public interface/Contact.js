...
function Contact() {
  return (
    <div>
      <section class="relative z-10 overflow-hidden bg-white py-20 px-9 ">
        <div class="container mx-auto">
          <div class="-mx-4 flex md:flex-wrap sm:flex-col lg:justify-between">
            <div class="w-full px-4 sm:px-0">
              <div class="mb-12 max-w-[570px] lg:mb-0">
                <span class="text-primary mb-4 block text-base font-semibold">
                  <span className="text-yellow-300 font-normal h-32">| </span>{" "}
                  Contact Us
                </span>
                <h2 class="text-dark mb-6 text-[32px] font-bold uppercase sm:font-semibold sm:text-md lg:text-[36px] xl:text-[40px]">
                ...
                <div class="mb-8 flex w-full max-w-[370px] sm:w-fulls">
                  <div class="bg-primary text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[30px]">
                    <svg
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
            ...
            <div class="w-full px-4 sm:mt-5 ">
              <div class="relative rounded-lg bg-white p-8 shadow-lg sm:p-4">
                <form>
                  <div class="mb-6">
                    <input
                      type="text"
