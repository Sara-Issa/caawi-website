      ...
      <div className="grid grid-cols-1 m-auto md:grid-col-2 md:m-auto lg:m-20 lg:grid-cols-2">
        <div className="w-10/12 shadow-md mt-10 mb-10 ml-10">
          <div className="relative py-8 px-5 md:px-10 bg-white shadow-sm rounded ">
            <h1 className="text-gray-800 text-4xl font-bold tracking-normal leading-tight mb-10">
              Apply The <strong className="text-yellow">Job</strong> 
            </h1>
            <form>
              ...
              <div className="relative mb-5 mt-2">
                ...
                <input
                  type="file"
                  className="mb-8 text-gray-600 focus:outline-none focus:border focus:border-yellow font-normal w-full h-10 flex items-center pl-3 pt-2 text-sm border-gray-300 rounded border"
                  placeholder="Upload Your CV"
                />
              </div>
              <div className="flex items-center justify-start w-full">
                <button className="focus:outline-none transition duration-150 ease-in-out hover:bg-yellow bg-yellow rounded text-white px-8 py-2 text-sm w-3/5 m-auto">
                  <strong>Apply</strong>
                </button>
              </div>
            </form>
        ...
        <div>
          ...
          <h1 className="font-extrabold text-3xl pt-14 pb-20 ml-20 lg:ml-10">
            Get the Chance To Be<strong className="text-purered"> Hired</strong><br /> Fill
            The Form And <strong className="text-yellow">Work </strong>With Us
          </h1>
        </div>
      </div>
    </div>
