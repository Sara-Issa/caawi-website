    ...
    <div>
        ...
        <div class="py-8">
          <div class="flex flex-row justify-between w-full mb-1 sm:mb-0">
            <h2 class="text-2xl leading-tight">List of Jobs Created </h2>
            <div class="text-end"><button
                  class="flex-shrink-0 px-4 py-2 text-base font-semibold text-white bg-yellow rounded-lg shadow-md hover:bg-yellow focus:outline-none focus:ring-2 focus:ring-yellow focus:ring-offset-2 focus:ring-offset-yellow"
                  type="submit"
                >
                  Create Job
                </button>
          ...
          <div class="px-4 py-4 -mx-4 mt-10 overflow-x-auto sm:-mx-8 sm:px-8">
              ...
              <thead>
                ...
                <tr>
                  ...
                  <td class="px-5 py-5 text-sm bg-white border-b border-gray-200">
                    ...
                    <td class="px-5 py-5 text-sm bg-white border-b border-gray-200">
                      <p class="text-gray-900 whitespace-no-wrap">01/20/2023</p>
                    </td>
                    <td class="px-5 py-5 text-sm bg-white border-b border-gray-200">
                      <span class="relative inline-block px-3 py-1 font-semibold leading-tight text-green-900">
                        <span
                  ...
                  <td class="px-5 py-5 text-sm bg-white border-b border-gray-200">
                    ...
                    <td class="px-5 py-5 text-sm bg-white border-b border-gray-200">
                      <p class="text-gray-900 whitespace-no-wrap">12/31/2022</p>
                    </td>
                    <td class="px-5 py-5 text-sm bg-white border-b border-gray-200">
                      <span class="relative inline-block px-3 py-1 font-semibold leading-tight text-green-900">
                        <span
