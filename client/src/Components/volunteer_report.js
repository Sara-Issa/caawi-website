      ...
      <div class="container w-10/12 px-4 mx-auto sm:px-8">
        <div class="py-8">
          <div class="flex flex-row justify-between w-full mb-1 sm:mb-0">
            <h2 class="text-2xl font-bold leading-tight my-4"><strong className="text-purered">Volunteer</strong> Applicant List</h2>
            <div class="text-end">
              ...
              <table class="min-w-full leading-normal">
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="px-5 py-5 text-sm bg-white border-b border-gray-200">
                      <p class="text-gray-900 whitespace-no-wrap">Hageisa</p>
                    </td>
                    <td class="px-5 py-5 text-sm bg-white border-b border-gray-200">
                    <p class="text-gray-900 whitespace-no-wrap">Medical Volunteer</p>
                    </td>
                    <td class="px-5 py-5 text-sm bg-white border-b border-gray-200">
                      <a href="#" class="text-purered font-bold hover:text-purered">
                        Approve
                      </a>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td class="px-5 py-5 text-sm bg-white border-b border-gray-200">
                    <p class="text-gray-900 whitespace-no-wrap">Cleaning Volunteer</p>
                    </td>
                    <td class="px-5 py-5 text-sm bg-white border-b border-gray-200">
                      <a href="#" class="text-purered font-bold hover:text-purered">
                        Approve
