            ...
            <div className="py-12 bg-gray-700 transition duration-150 ease-in-out z-10 absolute top-0 right-0 bottom-0 left-0" id="modal">
                <div role="alert" className="container mx-auto w-11/12 md:w-2/3 max-w-lg">
                    <div className="relative py-8 px-5 md:px-10 bg-white shadow-md rounded border border-gray-400">
                        ...
                        <input 
                        onChange={(e) => setDonationMoney({ ...donationMoney, name: e.target.value })}
                        ...
                        <div className="relative mb-5 mt-2">
                            ...
                            <input 
                            onChange={(e) => setDonationMoney({ ...donationMoney, phone: e.target.value })}
                        ...
                        <input 
                        onChange={(e) => setDonationMoney({ ...donationMoney, tixraac_no: e.target.value })}
                        id="name" className="mb-5 mt-2 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 font-normal w-full h-10 flex items-center pl-3 text-sm border-gray-300 rounded border" placeholder="James" />
                        ...
                        <div className="relative mb-5 mt-2">
                            ...
                            <input 
                            onChange={(e) => setDonationMoney({ ...donationMoney, cash_type: e.target.value })}
                            id="expiry" className="text-gray-600 focus:outline-none focus:border focus:border-indigo-700 font-normal w-full h-10 flex items-center pl-3 text-sm border-gray-300 rounded border" placeholder="MM/YY" />
                        </div>
                        ...
                        <div className="relative mb-5 mt-2">
                            ...
                            <input 
                            onChange={(e) => setDonationMoney({ ...donationMoney, amount: e.target.value })}
                            id="cvc" className="mb-8 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 font-normal w-full h-10 flex items-center pl-3 text-sm border-gray-300 rounded border" placeholder="MM/YY" />
                        </div>
                        <div className="flex items-center justify-start w-full">
                            <button className="focus:outline-none transition duration-150 ease-in-out hover:bg-indigo-600 bg-indigo-700 rounded text-white px-8 py-2 text-sm" onclick="">Submit</button>
                            </div>
                        </form>
